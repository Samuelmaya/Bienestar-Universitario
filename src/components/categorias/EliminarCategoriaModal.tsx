...
import { eliminarCategoria } from "@/shared/services/categorias.service";
...
export function EliminarCategoriaModal({ categoria, triggerElement, onClose, onDeleted }: Props) {
  ...
  const onConfirm = async () => {
    ...
    try {
      ...
      onDeleted(categoria.id_categoria);
    } catch (err) {
