...
import type { CategoriaArticulo, CategoriaCreateRequest } from "@/shared/dtos/categoria.dto";
import { crearCategoria } from "@/shared/services/categorias.service";

type Props = {
  triggerElement: HTMLElement | null;
  onClose: () => void;
  onCreated: (categoria: CategoriaArticulo) => void;
};

export function CrearCategoriaModal({ triggerElement, onClose, onCreated }: Props) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[420px] mx-auto pt-6 pb-10">
        ...
        >
          Registra una nueva categoria para los articulos deportivos.
        </p>
