...
import { actualizarRol } from "@/shared/services/roles.service";

type Props = {
  rol: Rol;
  triggerElement: HTMLElement | null;
  onClose: () => void;
  onUpdated: (rol: Rol) => void;
};

export function EditarRolModal({ rol, triggerElement, onClose, onUpdated }: Props) {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const updated = await actualizarRol(rol.id, {
