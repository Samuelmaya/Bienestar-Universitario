...
import type { Rol, RolCreateRequest } from "@/shared/dtos/rol.dto";
import { crearRol } from "@/shared/services/roles.service";
...
export function CrearRolModal({ triggerElement, onClose, onCreated }: Props) {
  const [form, setForm] = useState<RolCreateRequest>({ nombre: "", descripcion: "" });
  ...
  return (
    ...
    >
      <div className="w-full max-w-[420px] mx-auto pt-6 pb-10">
        ...
        >
          Registra un nuevo rol con permisos.
        </p>
